...
export class ShootTask extends Task {
    ...
    public static deserialize(data: any) {
        ...
        if (target) {
            return new ShootTask(target as Creep | Structure);
        } else {
            return null;
        }
    }
    ...
    public run(creep: Creep) {
        switch (creep.rangedAttack(this.target)) {
            case OK:
            case ERR_TIRED:
                break;
